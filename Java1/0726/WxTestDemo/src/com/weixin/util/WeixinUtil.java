...
public class WeixinUtil {
	...
	public static final String URL_WXTESTDEMO = "http://cwttw2.natappfree.cc";//服务器地址
	/**
	 * get璇锋眰
	 * @param url
	 * @return
...
//		我的积分
		...
		grade_btn.setUrl(URL_WXTESTDEMO+"/WxTestDemo/html/jifenlianghua.html");
//		操作指南
		ViewButton operator_btn = new ViewButton();//操作指南
		operator_btn.setName("操作指南");
		operator_btn.setType("view");
		operator_btn.setUrl(URL_WXTESTDEMO+"/WxTestDemo/html/index2.html");
		//设置子菜单
